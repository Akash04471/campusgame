...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://campus-undercover.vercel.app",
        "http://localhost:5173",
        "http://localhost:8000",
        "http://127.0.0.1:5173",
        "http://127.0.0.1:8000"
    ...
    try:
        while True:
            ...
            try:
                ...
                timer_limit = gs.modifiers.get('timer_seconds', 300)
                    ...
                    await send_to_player(room_code, pid_int, {
                        ...
                        "payload": {
                            **reveal,
                            ...
                            "time_remaining": result['modifiers']['timer_seconds'],
    ...
    if role:
        ...
        await websocket.send_json({
            ...
            "payload": {
                **reveal,
                "partner_name": partner_name,
                "timer_seconds": gs.modifiers.get('timer_seconds', 300),
                "difficulty": room.difficulty,
            }
        })
